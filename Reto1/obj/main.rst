...
Hexadecimal [16-Bits]
                              ...
                              8 .globl cpct_setDrawCharM1_asm
                              9 .globl cpct_drawCharM1_asm
   ...
   4000 CD 8C 40      [17]   16    call cpct_disableFirmware_asm
                             17 
                             18    ;; Set up draw char colours before calling draw string
   4003 16 00         [ 7]   19    ld    d, #0         ;; D = Background PEN (0)
   4005 1E 01         [ 7]   20    ld    e, #1         ;; E = Foreground PEN (3)
                             21 
   4007 CD 9D 40      [17]   22    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             23 
   400A 1E 48         [ 7]   24    ld e, #'H'
   400C 21 00 C0      [10]   25    ld hl, #0xC000
                             26 
   400F CD 5E 40      [17]   27    call cpct_drawCharM1_asm    ;; Dibuja caracteres
                             28 
   4012 1E 49         [ 7]   29    ld e, #'I'
   4014 21 01 C0      [10]   30    ld hl, #0xC001
                             31 
   4017 CD 5E 40      [17]   32    call cpct_drawCharM1_asm    ;; Dibuja caracteres
                             33 
                             34    ;; Loop forever
   401A                      35 loop:
   401A CD EE 40      [17]   36    call cpct_scanKeyboard_asm ;;llig i emmagatzema teclat
   401D CD 7F 40      [17]   37    call cpct_isAnyKeyPressed_asm 
                             38 
   4020 20 02         [12]   39    jr nz, letraA ;;si A pulsada cambia color
                             40 
   4022 18 F6         [12]   41    jr    loop
                             42 
   4024                      43 letraA:
   4024 21 08 20      [10]   44    ld hl, #Key_A ;;detecta tecla A
   4027 CD 52 40      [17]   45    call cpct_isKeyPressed_asm 
   402A 20 02         [12]   46    jr nz, cian
   402C 28 11         [12]   47    jr z, fallo
   402E                      48 cian:
   402E 16 00         [ 7]   49    ld    d, #0         ;; D = Background PEN (0)
   4030 1E 02         [ 7]   50    ld    e, #2         ;; E = Foreground PEN (2) cian
                             51 
   4032 CD 9D 40      [17]   52    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             53 
   4035 1E 41         [ 7]   54    ld e, #65
   4037 21 00 C0      [10]   55    ld hl, #0xC000
                             56 
...
Hexadecimal [16-Bits]
   ...
   403A CD 5E 40      [17]   57    call cpct_drawCharM1_asm    ;; Dibuja caracteres
                             58 
   403D 18 11         [12]   59    jr infinito          ; bucle infinito;
                             60 
   403F                      61 fallo:
   403F 16 00         [ 7]   62    ld    d, #0         ;; D = Background PEN (0)
   4041 1E 03         [ 7]   63    ld    e, #3         ;; E = Foreground PEN (2) cian
                             64 
   4043 CD 9D 40      [17]   65    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             66 
   4046 1E 2D         [ 7]   67    ld e, #'-'
   4048 21 00 C0      [10]   68    ld hl, #0xC000
                             69 
   404B CD 5E 40      [17]   70    call cpct_drawCharM1_asm    ;; Dibuja caracteres
                             71 
   404E 18 00         [12]   72    jr infinito          ; bucle infinito;
                             73 
   4050                      74 infinito:
   4050 18 FE         [12]   75    jr infinito
