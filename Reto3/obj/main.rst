...
Hexadecimal [16-Bits]
                              ...
                              5 
                              6 ;;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                              7 ;; DECLARATION OF GLOBAL SYMBOLS TO BE USED
                              8 ;;    This informs the linker, who will link the translation of this
                              9 ;; file against the files containing these symbols
                             10 ;;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                             11 .globl cpct_disableFirmware_asm
                             12 .globl cpct_setVideoMode_asm
                             13 .globl cpct_setPalette_asm
                             14 .globl cpct_px2byteM0_asm
                             15 
                             16 ;;##########################################################
                             17 ;;## PALETTE
                             18 ;;##  Hardware values for the colors of the Mode 0 Palette
                             19 ;;##########################################################
   4000                      20 palette:
   4000 14 04 1D 1C          21    .db   HW_BLACK, HW_BLUE, HW_MAUVE, HW_RED
   4004 0C 0C 0C 03          22    .db   HW_BRIGHT_RED, HW_BRIGHT_RED, HW_BRIGHT_RED, HW_PASTEL_YELLOW
   4008 03 03 0A 0A          23    .db   HW_PASTEL_YELLOW, HW_PASTEL_YELLOW, HW_BRIGHT_YELLOW, HW_BRIGHT_YELLOW
   400C 0A 0B 0B 0B          24    .db   HW_BRIGHT_YELLOW, HW_BRIGHT_WHITE, HW_BRIGHT_WHITE, HW_BRIGHT_WHITE
                             25 
                             26 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             27 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             28 ;; INITIALIZE
                             29 ;;  Initializes the Amstrad CPC: no firmware, mode 0, palette, border black.
                             30 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             31 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4010                      32 initialize:
   4010 CD F2 46      [17]   33    call cpct_disableFirmware_asm
   4013 0E 00         [ 7]   34    ld  c, #0
   4015 CD CB 46      [17]   35    call cpct_setVideoMode_asm
   4018 21 00 40      [10]   36    ld  hl, #palette
   401B 11 10 00      [10]   37    ld  de, #16
   401E CD AE 46      [17]   38    call cpct_setPalette_asm
                             39 
   0021                      40    cpctm_setBorder_asm HW_BLACK
                              1    .radix h
   0021                       2    cpctm_setBorder_raw_asm \HW_BLACK ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   4021 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   4024 CD C1 46      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
                             41 
   4027 C9            [10]   42    ret
                             43 
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             45 ;; TEST1
                             46 ;;  Tests mode and palette, by drawing it to video memory.
                             47 ;;  test_vals are the values for the pixels
                             48 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             49 
   4028                      50 test_vals:
...
Hexadecimal [16-Bits]
   ...
   4028 40 4C 70 7C 43 4F    51    .db 0x40, 0x4C, 0x70, 0x7C, 0x43, 0x4F, 0x73, 0x7F
        73 7F
   4030                      52 test1:
                             53    ;; amb px2byte
                             54    ;ld h, #0
                             55    ;ld l, #1
                             56    ;call cpct_px2byteM0_asm
                             57 
                             58    ;;; amb test vals
                             59    ;ld hl, (test_vals)
                             60    ;ld (#0xC000), hl
                             61 
                             62    ;ld hl, (test_vals+2)
                             63    ;ld (#0xC002), hl
                             64 
                             65    ;ld hl, (test_vals+4)
                             66    ;ld (#0xC004), hl
                             67 
                             68    ;ld hl, (test_vals+6)
                             69    ;ld (#0xC006), hl
                             70 
   4030 21 28 40      [10]   71    ld hl, #test_vals
   4033 11 00 C0      [10]   72    ld de, #0xC000
   4036 01 08 00      [10]   73    ld bc, #8
                             74 
   4039 ED B0         [21]   75    ldir
                             76 
   403B C9            [10]   77    ret
                             78 
                             79 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             80 ;; FILL WITH RANDOMS 0-15
                             81 ;;    Must fill an array with random bytes from 0 to 15
                             82 ;; INPUT:
                             83 ;;    - DE: Address where the array starts (pointer to array)
                             84 ;;    -  B: Number of randoms to generate (Size)
                             85 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   403C                      86 fill_with_randoms:
                             87    ;;
                             88    ;; @@@@@ IMPLEMENT @@@@@
                             89    ;;
   403C C9            [10]   90    ret
                     ...
                     0028    92 width = 40
                     0028    93 height = 40                
   403D 00                   94 _num_entities:: .db 0               
   403E 40 40                95 _last_elem_ptr:: .dw _entity_array  ;;define word, posa 2bytes que li digues ...
   4040                      96 _entity_array::                     ;;define space, reserva nº de bytes que li ...
   4040                      97     .ds width * height
   4680                      98 create_array:
   4680 ED 5B 3E 40   [20]   99    ld  de, (_last_elem_ptr)    ;;puntero on vull copiar 
   4684 01 28 00      [10]  100    ld  bc, #width           ;;contador
   4687 ED B0         [21]  101    ldir
                            102 
   4689 3A 28 00      [13]  103    ld  a, (height)
   468C 3C            [ 4]  104    inc a
...
Hexadecimal [16-Bits]
                            ...
                            105    
   468D 32 3D 40      [13]  106    ld  (_num_entities), a      ;;"_num_entities++"
   4690 2A 3E 40      [16]  107    ld  hl, (_last_elem_ptr)
   4693 01 28 00      [10]  108    ld  bc, #width           ;;reestablim
   4696 09            [11]  109    add hl, bc                  ;;preparem següent pos array
                            110 
   4697 22 3E 40      [16]  111    ld  (_last_elem_ptr), hl    ;;actualitzem
                            112 
   469A C9            [10]  113    ret
                            114 
                            115 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            116 ;; MAIN: Start of the program
                            117 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   469B                     118 _main::
   469B CD 10 40      [17]  119    call initialize
   469E CD 30 40      [17]  120    call test1
                            121 
   46A1 CD 80 46      [17]  122    call create_array
                            123 
   46A4 11 40 40      [10]  124    ld de, #0x4040
   46A7 06 28         [ 7]  125    ld b, #width 
   46A9 CD 3C 40      [17]  126    call fill_with_randoms
   46AC                     127 loop:
   46AC 18 FE         [12]  128    jr loop
